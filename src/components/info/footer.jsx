...
function Footer() {
  return (
    <div className="footer">
      <div className="px-72">
        <div className="footer-container d-flex align-items-baseline">
          ...
          <div className="footer-text">
            ...
            <span className="ml-40">Privacy</span>
            <span className="ml-40">Google Nest Commitment to Privacy</span>
            <span className="ml-40">Sales Terms</span>
            <span className="ml-40">Terms of Service</span>
            <span className="ml-40">Careers</span>
          </div>
        </div>
      </div>
    </div>
